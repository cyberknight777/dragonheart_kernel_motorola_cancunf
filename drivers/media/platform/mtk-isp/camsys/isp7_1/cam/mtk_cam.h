...
static bool inline raw_pipe_data_check(int a)
{
	bool result;
...
static bool inline p_data_check(int a)
{
	bool result;
...
static bool inline sv_pipe_check(int a)
{
	bool result;
...
static bool inline sv_devs_check(int a)
{
	bool result;
