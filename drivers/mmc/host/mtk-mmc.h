 ...
 * out of tolerance
 */
static u32 __maybe_unused bad_sd_tolerance[BAD_SD_DETECTER_COUNT] = {10};

/* bad sd condition occur times
 */
static u32 __maybe_unused bad_sd_detecter[BAD_SD_DETECTER_COUNT] = {0};
 ...
 */
static u32 __maybe_unused bad_sd_forget[BAD_SD_DETECTER_COUNT] = {3};

/* the latest occur time of the bad sd condition,
 * unit: clock
 */
static unsigned long __maybe_unused bad_sd_timer[BAD_SD_DETECTER_COUNT] = {0};
