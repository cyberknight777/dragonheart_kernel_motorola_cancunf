...
#define BQ25980_REG_RESET       BIT(7)
#define BQ25980_EN_OTG		BIT(5)
#define BQ25980_DIS_MOS_BOTH		BIT(2)
#define BQ25980_ENABLE_TYPEC_MOS		BIT(1)
#define BQ25980_ENABLE_WLC_MOS		BIT(0)
#define BQ25980_STAT1_OVP_MASK		(BIT(7) | BIT(5) | BIT(1))
#define BQ25980_STAT3_OVP_MASK		(BIT(7) | BIT(6))
#define BQ25980_STAT1_BATOVP_MASK		BIT(7)
#define BQ25980_STAT1_VOUTOVP_MASK		BIT(5)
#define BQ25980_STAT1_VBUSOVP_MASK		BIT(1)
#define BQ25980_STAT1_OCP_MASK		BIT(4)
#define BQ25980_STAT2_OCP_MASK		BIT(7)
#define BQ25980_STAT2_BUSUCP_MASK		BIT(5)
...
#define SC8545_BATOVP_DFLT_uV               44000000
#define SC8545_BATOVP_MAX_uV                47700000
#define SC8545_BATOVP_MIN_uV                35000000
#define SC8545_BATOVP_STEP_uV               10000
#define SC8545_BATOVP_OFFSET_uV             35000000

#define SC8545_BATOCP_DFLT_uA               71000000
#define SC8545_BATOCP_MAX_uA                127000000
