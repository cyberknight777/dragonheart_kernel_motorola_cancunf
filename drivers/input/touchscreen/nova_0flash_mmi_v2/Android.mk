...
ifeq ($(CONFIG_NOVATEK_MTK_SPI),true)
        KERNEL_CFLAGS += CONFIG_NOVATEK_MTK_SPI=y
endif
...
ifeq ($(NOVATEK_STOWED_MODE_SUPPORT),true)
	KERNEL_CFLAGS += CONFIG_STOWED_MODE_SUPPORT=y
endif
...
ifneq ($(BOARD_USES_MTK_CHECK_PANEL),)
	KERNEL_CFLAGS += CONFIG_NOVA_MTK_CHECK_PANEL=y
endif
...
ifeq ($(NVT_ESD_RECOVERY_SUPPORT),true)
        KERNEL_CFLAGS += CONFIG_NVT_ESD_RECOVERY_SUPPORT=y
endif
