...
#if defined(MOT_CANCUNN_OV50D_MIPI_RAW)
	{
		SENSOR_DRVNAME_MOT_CANCUNN_OV50D_MIPI_RAW,
		{
			{SensorMCLK, Vol_High,1},
			{RST, Vol_Low, 1},
			{DVDD1, Vol_High, 1},
...
#endif
#if defined(MOT_CANCUNN_HI1634Q_MIPI_RAW)
	{
...
#endif
#if defined(MOT_CANCUNN_S5K4H7_MIPI_RAW)
	{
		SENSOR_DRVNAME_MOT_CANCUNN_S5K4H7_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DVDD, Vol_High, 1},
...
#endif
#if defined(MOT_CANCUNF_S5KJNS_MIPI_RAW)
	{
		SENSOR_DRVNAME_MOT_CANCUNF_S5KJNS_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DOVDD, Vol_High, 0},
